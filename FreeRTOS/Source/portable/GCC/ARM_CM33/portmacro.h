...
#ifdef configFIRST_MPU_REGION
#define portFIRST_CONFIGURABLE_REGION	configFIRST_MPU_REGION
#else
#define portFIRST_CONFIGURABLE_REGION	( 4UL )
#endif

#ifdef configLAST_MPU_REGION
#define portLAST_CONFIGURABLE_REGION	configLAST_MPU_REGION
#else
