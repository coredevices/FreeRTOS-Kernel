...
_Static_assert( configFIRST_MPU_REGION % 4U == 0U,
			    "configFIRST_MPU_REGION must be a multiple of 4" );
_Static_assert( portNUM_CONFIGURABLE_REGIONS % 4U == 0U,
			    "# of MPU regions must be a multiple of 4" );
...
#define RNR_OFFSET portFIRST_CONFIGURABLE_REGION
		"	ldr r2, =0xe000ed98					\n" /* r2 = 0xe000ed98 [MPU_RNR] */
		"	mov r4, #" STR(RNR_OFFSET) "		\n" /* r4 = RNR_OFFSET */
		"	str r4, [r2]						\n" /* MPU_RNR = RNR_OFFSET */
		"										\n"
...
#undef RNR_OFFSET
#endif
#if portNUM_CONFIGURABLE_REGIONS > 4
#define RNR_OFFSET portFIRST_CONFIGURABLE_REGION + 4
		"	ldr r2, =0xe000ed98					\n" /* r2 = 0xe000ed98 [MPU_RNR] */
		"	mov r4, #" STR(RNR_OFFSET) "		\n" /* r4 = RNR_OFFSET */
		"	str r4, [r2]						\n" /* MPU_RNR = RNR_OFFSET */
		"										\n"
...
#undef RNR_OFFSET
#endif
#if portNUM_CONFIGURABLE_REGIONS > 8
#define RNR_OFFSET portFIRST_CONFIGURABLE_REGION + 8
		"	ldr r2, =0xe000ed98					\n" /* r2 = 0xe000ed98 [MPU_RNR] */
		"	mov r4, #" STR(RNR_OFFSET) "		\n" /* r4 = RNR_OFFSET */
		"	str r4, [r2]						\n" /* MPU_RNR = RNR_OFFSET */
		"										\n"
...
#undef RNR_OFFSET
#endif
#if portNUM_CONFIGURABLE_REGIONS > 12
#define RNR_OFFSET 12
		"	ldr r2, =0xe000ed98					\n" /* r2 = 0xe000ed98 [MPU_RNR] */
		"	mov r4, #" STR(RNR_OFFSET) "		\n" /* r4 = RNR_OFFSET */
		"	str r4, [r2]						\n" /* MPU_RNR = RNR_OFFSET */
		"										\n"
